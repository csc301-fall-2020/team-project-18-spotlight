  ...
  return (
    ...
    <View style={styles.container}>
      ...
      <View style={styles.buttons}>
        <Text style={styles.secondTitle}> The #1 App to find your gym buddies</Text>
        <Text style={styles.secondSubitle}>It's time to be someone in the gym</Text>
        <Button
          icon="google"
          mode="contained"
          style={styles.google}
        ...
        <Text style={{color:"grey", marginBottom:15}}> ------- Already have an account? -------</Text>
