...
const WorkoutDetails = (props) => {
    ...
    const removeExercise = (index) => {
        setExercises(exercises => [...exercises.slice(0, index), ...exercises.slice(index+1)])
    }
          ...
          <View
            ...
            {exercises.map((exercise, index) => {
                return (
                    ...
                    >
                        <Text style={{flex: 0.6, textAlign: 'center', color: "white",}}>{exercise.title}</Text>
                        <Text style={{flex: 0.2, textAlign: 'center', color: "white",}}>{exercise.weight}</Text>
                        <Text style={{flex: 0.2, textAlign: 'center', color: "white",}}>{exercise.reps}</Text>
                    </TouchableOpacity>
                );
            })}
